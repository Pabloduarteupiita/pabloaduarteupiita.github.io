...
forma.faces.push(new THREE.Face4(0,1,4,6)); //cara 1
//forma.faces.push(new THREE.Face3(2,3,7)); //cara 2
//forma.faces.push(new THREE.Face3(0,2,6)); //cara 3
//forma.faces.push(new THREE.Face3(2,6,4)); //cara 4
